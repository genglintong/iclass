...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
				...
				<div class="layui-main">
					<div class="admin-login-box">
						<a class="logo" style="left: 0;" href="index.html">
							<span style="font-size: 22px;"><b>课程管理系统-学生</b></span>
						</a>
					...
					<ul class="layui-nav admin-header-item">
						<li class="layui-nav-item">
							<a href="javascript:;" class="admin-header-user">
								<img src="${pageContext.request.contextPath}/demo_student/images/people.jpg" />
								<span><s:property value="#session.existStudent.studentName"/></span>
							</a>
							<dl class="layui-nav-child">
							<dd>
								<a id="logout" href="Student_stuLogout.action"><i class="fa fa-sign-out" aria-hidden="true"></i> 退出系统</a>
							</dd>
							</dl>
						</li>
					</ul>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/demo_student/plugins/layui/layui.js"></script>
	<script >
	var navs = [{
		"title": "我的课程",
		"icon": "fa-cubes",
...
//	 	}]
	...
	<script src="${pageContext.request.contextPath}/demo_student/js/index.js"></script>
</body>
</html>
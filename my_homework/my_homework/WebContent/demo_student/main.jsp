	...
	<body>
		<div class="admin-main">
			<blockquote class="layui-elem-quote">
				<p><s:property value="#session.existStudent.studentName"/>&nbsp;&nbsp;同学你好，欢迎使用iclass管理平台，你可以在下方选择你的课程。</p>
			</blockquote>
			...
			<fieldset class="layui-elem-field" style="margin-top:1%;">
				...
				<form class="layui-form layui-form-pane" action="Student_setCurrentCourse.action" >
					<table class="site-table table-hover">
							...
							<tbody>
								<tr>
									<td>
									<s:iterator>
									<s:if test="#session.currentCourse.courseId == courseId">
			...
			<s:iterator value="#session.subject_course" var="x">
			<blockquote class="layui-elem-quote layui-quote-nm">
				<b>系统消息：</b>
				<font style="color: red;">你的 <s:property value="#x.subjectDesc"/> 课程 <s:property value="#x.subjectTitle"/> 作业提交日期还有不到3天就要截止啦，上方选择课程后快去小组作业模块查看~~~</font>
			</blockquote>
			</s:iterator>
